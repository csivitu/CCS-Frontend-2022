        ...
        <div className="w-4/5 max-w-4xl flex flex-col content-center justify-items-center">
                ...
                return (
                    i === position && (
                        <div key={i}>
                            ...
                            <div className="flex flex-row font-bold pt-10 pb-4">YOUR ANSWER</div>
            ...
            <div className="flex flex-col md:flex-row items-center rounded-md py-5 gap-4 justify-between">
                <div className="flex flex-row rounded-md gap-4">
                    <button onClick={decreasePosition} className="text-gray-dark bg-stone-300 p-2 px-8 rounded-md">
                        PREVIOUS
                    </button>
                    <button onClick={increasePosition} className="text-gray-dark bg-stone-300 p-2 px-8 rounded-md">
                        NEXT
                    </button>
                    {!isChecking && (
                        <button
            ...
            {domain === 'tech' && (
                <div>
                    ...
                    <form onSubmit={(e) => submitHandler('tech', e)} className="flex flex-col gap-2">
